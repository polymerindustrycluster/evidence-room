...
doc = {
    "meta": {
        "source": "PIC funding map, EDA Sustainable Polymers Tech Hub. Figures verified "
                  "against signed federal Notices of Award; see funding-map.",
        "row": "one EDA implementation award to one project lead",
        "derived_note": "Generated by derive_techhub.py from funding-map/data/funding.json "
                        "(already in this repo, as of %s). No new fetch: every figure is "
                        "copied from that file and re-aggregated here so this page can "
                        "chart it." % f["meta"]["asOf"],
